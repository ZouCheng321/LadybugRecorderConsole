CXX = g++
CXXFLAGS := -Wall -pthread -fPIC -std=c++11
...
BOOST_INCLUDE = -I${SOFTWARE_LIB}/Boost/boost_1_60_0
ALL_INCLUDE = ${LADYBUG_API_INCLUDE} ${BOOST_INCLUDE}

# Lib path
LADYBUG_LIB = -L../../lib -lflycapture -lptgreyvideoencoder -lladybug${D} 

# Third party libs
LBITS := $(shell getconf LONG_BIT)
ifeq ($(LBITS),64)
	BOOST_LIB = -L${SOFTWARE_LIB}/Boost/boost_1_60_0/GCC_5_3_1/linux_cpp11/release/amd64/lib -lboost_thread -lboost_date_time -lboost_system -lboost_filesystem
else
	BOOST_LIB = -L${SOFTWARE_LIB}/Boost/boost_1_60_0/GCC_5_3_1/linux_cpp11/release/i386/lib -lboost_thread -lboost_date_time -lboost_system -lboost_filesystem
endif
...
LadybugRecorderConsoleConfiguration.cpp: LadybugRecorderConsoleConfiguration.xsd
	xsdcxx cxx-tree --show-sloc --sloc-limit 10000 --output-dir . --proprietary-license --hxx-suffix .h --cxx-suffix .cpp --ixx-suffix .inl --fwd-suffix -fwd.h --namespace-map http://www.ptgrey.com=LRCConfig --generate-serialization --generate-ostream --generate-doxygen --generate-intellisense --type-naming ucc --function-naming java $<
